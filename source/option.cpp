...
// 数字キーボードで入力
double input_number_keyboard(int max_digits, bool isDot, bool isMinus)
{ // 最大桁数、少数、マイナス
	...
	if (isDot && isMinus == false)
		swkbdSetNumpadKeys(&swkbd, L'.', 0);
	if (isDot == false && isMinus)
		swkbdSetNumpadKeys(&swkbd, L'-', 0);
	if (isDot && isMinus == true)
...
void draw_option(u16 px, u16 py, unsigned int key, C2D_Sprite sprites[SPRITES_NUMER])
{
	...
	case 1:
		...
		if ((y < py && y + height > py && x < px && x + width > px) && key & KEY_TOUCH)
		{
			...
			if (Option.speed > 10.0)
				Option.speed = 10.0;
			else if (Option.speed < 1.0)
				Option.speed = 1.0;
		}
		x = XSense * XCnt + gap, y = YSense * YCnt, ++XCnt;
	...
	case 2:
		...
		x = XSense * XCnt + gap, y = YSense * YCnt, ++XCnt;
		if (Option.offset == 0)
			snprintf(get_buffer(), BUFFER_SIZE, "±%.3f", Option.offset);
		...
		if ((y < py && y + height > py && x < px && x + width > px) && key & KEY_TOUCH)
		{
			...
			if (Option.musicspeed > 2.0)
				Option.musicspeed = 2.0;
			else if (Option.musicspeed < 0.5)
				Option.musicspeed = 0.5;
		}
		x = XSense * XCnt + gap, y = YSense * YCnt, ++XCnt;
		draw_option_text(x, y, Text[Option.lang][TEXT_RESET], true, &width, &height);
		if ((y < py && y + height > py && x < px && x + width > px) && key & KEY_TOUCH)
	...
	case 4:
		...
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_A);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_B);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_Y);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_X);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_DRIGHT);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_DDOWN);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_DLEFT);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_DUP);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_L);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_ZL);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_ZR);
		...
		width = 26, height = 26, x2 = x - 5, y2 = y - 5;
		if ((y2 < py && y2 + height > py && x2 < px && x2 + width > px) && key & KEY_TOUCH)
			switch_button_mapping(&Option.KEY_R);
		break;
